...
Stacktrace:
 [1] _throw_dims_error(D::Int64, d::Int64)
   @ MultilinearMaps ~/Development/julia/MultilinearMaps/src/stdbasis.jl:43
 [2] StdUnitVector
   @ ~/Development/julia/MultilinearMaps/src/stdbasis.jl:29 [inlined]
 [3] StdUnitVector{2}(d::Int64)
   @ MultilinearMaps ~/Development/julia/MultilinearMaps/src/stdbasis.jl:33
 [4] top-level scope
   @ In[7]:1
 [5] eval
   @ ./boot.jl:373 [inlined]
...
#+RESULTS:
: 2-element StdUnitVector{2} with indices SOneTo(2):
:  0
:  0
...
#+RESULTS:
: [0m[1mTest Summary:              | [22m[32m[1mPass  [22m[39m[36m[1mTotal[22m[39m
: Multilinear Form -> Scalar | [32m   9  [39m[36m    9[39m
...
#+RESULTS:
: [0m[1mTest Summary:       | [22m[32m[1mPass  [22m[39m[36m[1mTotal[22m[39m
: StaticArrays traits | [32m   4  [39m[36m    4[39m
...
#+RESULTS:
: [0m[1mTest Summary:     | [22m[32m[1mPass  [22m[39m[36m[1mTotal[22m[39m
: More contractions | [32m   2  [39m[36m    2[39m
